...
"""
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Open Profile", 
            web_app=WebAppInfo(url="https://content-flow-fix-2.preview.emergentagent.com/profile"))],
...
"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🌐 Web Settings", 
            web_app=WebAppInfo(url="https://content-flow-fix-2.preview.emergentagent.com/settings"))]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
def main():
    ...
    logger.info("🌐 Web App: https://content-flow-fix-2.preview.emergentagent.com")
