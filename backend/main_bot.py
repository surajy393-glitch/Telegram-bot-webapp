    ...
    if existing_user and existing_user.get("registration_complete"):
        ...
        keyboard = [
            [InlineKeyboardButton("🌐 Open Web App", 
                web_app=WebAppInfo(url="https://luvhive-telebot.preview.emergentagent.com"))],
...
"""
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Open Profile", 
            web_app=WebAppInfo(url="https://luvhive-telebot.preview.emergentagent.com/profile"))],
...
"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🌐 Web Settings", 
            web_app=WebAppInfo(url="https://luvhive-telebot.preview.emergentagent.com/settings"))]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
def main():
    ...
    logger.info("🌐 Web App: https://luvhive-telebot.preview.emergentagent.com")
