...
"""
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Open Profile", 
            web_app=WebAppInfo(url="https://bot-web-interface.preview.emergentagent.com/profile"))],
...
"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🌐 Web Settings", 
            web_app=WebAppInfo(url="https://bot-web-interface.preview.emergentagent.com/settings"))]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
