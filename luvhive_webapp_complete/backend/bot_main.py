...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Open Web App", web_app={"url": "https://bot-web-interface.preview.emergentagent.com"})],
...
async def profile_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not user_data or not user_data.get("is_onboarded"):
        keyboard = [[InlineKeyboardButton("🌐 Complete Setup", web_app={"url": "https://bot-web-interface.preview.emergentagent.com"})]]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
"""
    ...
    keyboard = [[InlineKeyboardButton("🌐 Open Profile", web_app={"url": "https://bot-web-interface.preview.emergentagent.com"})]]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
"""
    ...
    keyboard = [[InlineKeyboardButton("🌐 Open App", web_app={"url": "https://bot-web-interface.preview.emergentagent.com"})]]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
"""
        keyboard = [[InlineKeyboardButton("🌐 Open Web App", web_app={"url": "https://bot-web-interface.preview.emergentagent.com"})]]
        reply_markup = InlineKeyboardMarkup(keyboard)
