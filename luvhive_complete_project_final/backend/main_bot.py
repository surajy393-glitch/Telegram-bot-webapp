...
"""
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Open Profile", 
            web_app=WebAppInfo(url="https://telegram-social.preview.emergentagent.com/profile"))],
...
"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🌐 Web Settings", 
            web_app=WebAppInfo(url="https://telegram-social.preview.emergentagent.com/settings"))]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
